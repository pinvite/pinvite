...
export const H1Centered: React.SFC<DescriptionProps> = (props) =>
  ...
  <Atom className={props.className}>
    <Typography variant='h1' align='center'>{props.description}</Typography>
  </Atom>
...
export const H2Centered: React.SFC<DescriptionProps> = (props) =>
  ...
  // Only margin, no other CSS property from outside.
  <Atom className={props.className}>
    <Typography variant='h2' align='center'>{props.description}</Typography>
  </Atom>
...
export const H3Centered: React.SFC<DescriptionProps> = (props) =>
  ...
  // Only margin, no other CSS property from outside.
  <Atom className={props.className}>
    <Typography variant='h3' align='center'>{props.description}</Typography>
  </Atom>
...
export const H4Centered: React.SFC<DescriptionProps> = (props) =>
  ...
  // Only margin, no other CSS property from outside.
  <Atom className={props.className}>
    <Typography variant='h4' align='center'>{props.description}</Typography>
  </Atom>
...
export const H5Centered: React.SFC<DescriptionProps> = (props) =>
  ...
  // Only margin, no other CSS property from outside.
  <Atom className={props.className}>
    <Typography variant='h5' align='center'>{props.description}</Typography>
  </Atom>
...
export const Subtitle2Centered: React.SFC<DescriptionProps> = (props) =>
  ...
  // Only margin, no other CSS property from outside.
  <Atom className={props.className}>
    <Typography variant='subtitle2' align='center'>{props.description}</Typography>
  </Atom>
...
export const CaptionCentered: React.SFC<DescriptionProps> = (props) =>
  ...
  // Only margin, no other CSS property from outside.
  <Atom className={props.className}>
    <Typography variant='caption' align='center'>{props.description}</Typography>
  </Atom>
...
export const OverlineCentered: React.SFC<DescriptionProps> = (props) =>
  ...
  // Only margin, no other CSS property from outside.
  <Atom className={props.className}>
    <Typography variant='overline' align='center'>{props.description}</Typography>
  </Atom>
